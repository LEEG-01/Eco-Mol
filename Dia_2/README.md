...
Anotar o genoma no anotador Helixer:

https://www.plabipd.de/helixer_main.html
 
# Atividade: Abrir o GFF3
less helixer.gff3
Contar quantos: gene / mRNA / exon / CDS
Comando 
awk '$3=="gene"' helixer.gff3 | wc -l
...
Galaxy
A) InterProScan (domínios proteicos)
 Procurar ferramenta
InterProScan
...
	Interpretação biológica do exemplo
Essa proteína tem 642 aa; contém um domínio de ligação a ATP; pertence à família das proteínas quinases; participa de vias de sinalização (Reactome); função molecular bem definida (ATP binding);
